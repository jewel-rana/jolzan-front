        ...
        <div class="row match-height">
            ...
            <div class="col-12">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link @if($tab === 'general') active @endif" id="general-tab" data-toggle="tab" href="#general"
                           aria-controls="general" role="tab" aria-selected="true"> General
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if($tab === 'header') active @endif" id="header-tab" data-toggle="tab" href="#header"
                           aria-controls="header" role="tab" aria-selected="false"> Header
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if($tab === 'footer') active @endif" id="footer-tab" data-toggle="tab" href="#footer"
                           aria-controls="footer" role="tab" aria-selected="false"> Footer
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if($tab === 'home') active @endif" id="home-tab" data-toggle="tab" href="#home"
                           aria-controls="home" role="tab" aria-selected="false">Homepage
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link @if($tab === 'seo') active @endif" id="seo-tab" data-toggle="tab" href="#seo"
