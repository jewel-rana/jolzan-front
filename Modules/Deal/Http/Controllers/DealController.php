...
use Modules\Deal\Entities\Package;
...
class DealController extends Controller
{
    ...
    {
        $packages = Package::pluck('name', 'id')->get();
        return view('deal::create', compact($packages))->withTitle('Add new deal');
    }
    ...
    {
        $packages = Package::pluck('name', 'id')->get();
        return view('deal::edit', compact('deal', 'packages'))->withTitle('Update deal');
    }
