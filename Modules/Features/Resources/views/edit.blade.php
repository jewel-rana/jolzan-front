                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" class="form-control" name="title"
                                               value="{{ old('title', $feature->title) }}" placeholder="Page title" required/>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="external_link" value="{{ old('external_link', $feature->external_link) }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="type" class="form-control" name="type" required>
                                    ...
                                    @foreach(config('constants.feature_types') as $key => $value)
                                        <option value="{{"$key"}}" @if(old('type', $feature->type) == $key) selected @endif>{{$value}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <button type="submit"
                                        class="btn btn-primary form-control mr-1">{{ __('Update featue') }}</button>
                            </div>
                        </div>
                    </div>
