        ...
        if($request->wantsJson()) {
            ...
            return Datatables::of($sliders)
                ...
                ->addColumn('action', function($slider) {
                    return "<a href='" . route('slider.show', $slider->id) . "' class='btn btn-outline-secondary'>Manage</a><a href='" . route('slider.edit', $slider->id) . "' class='btn btn-outline-secondary'>Edit</a>";
                })
